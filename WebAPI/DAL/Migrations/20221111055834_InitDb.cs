        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NameOfSpecialization = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartWorkDay = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndWorkDay = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    FreeTime = table.Column<List<TimeOnly>>(type: "time without time zone[]", nullable: true)
                },
                constraints: table =>
                {
